window.INVITATION_DATA = Object.freeze({
  ...
  family: {
    groomLine: '아버지 어머니의 아들 신랑',
    brideLine: '아버지 어머니의 딸 신부',
  },
  concepts: {
    regency: {
  ...
  accounts: {
    brideFather: '은행 000-0000-0000 예금주',
    bride: '은행 000-0000-0000 예금주',
    groomMother: '은행 000-0000-0000 예금주',
    groom: '은행 000-0000-0000 예금주',
  },
  site: { url: '' },
  rsvp: { endpoint: '' },
  guestbook: { endpoint: '' },
