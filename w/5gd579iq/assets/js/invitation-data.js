...
window.INVITATION_DATA = Object.freeze({
  ...
  directions: {
    ...
    official: {
      ...
      // 두 경로 모두 천안역 1번 출구로 모이므로 노선 하나만 다른 이 사실은 목록 밖에 한 번만 적는다.
      railBus500: '500번 버스는 삼도상가(동부광장방면) 정류장에서 타실 수 있습니다.',
