...
window.INVITATION_DATA = Object.freeze({
  ...
  venue: {
    ...
    maps: {
      ...
      kakaoRoughmaps: { venue: { timestamp: '1785487650547', key: 's59597zif2p' }, olive: { timestamp: '1785504410724', key: 's5m2eskwnqk' }, gs25: { timestamp: '1785504449156', key: 's5m3bjpfrf9' } },
    },
  },
  /*
  ...
  directions: {
    ...
    stationPrint: '1번 출구 동부역에서 24 · 383 · 400 · 401 · 500 승차 → 세광엔리치빌 하차',
    ...
    official: {
       ...
       * 노선 목록이 위 bus(12개)와 다른 것은 공식 카드가 그렇게 적어서다 — 병합하지 않는다.
       */
      railStation: [
        '천안역에서 기차 또는 전철에서 내립니다.',
        '1번 출구 동부역으로 나갑니다.',
        '24, 383, 400, 401, 500번 버스를 탑니다.',
        '세광엔리치빌 정류장에서 내립니다.',
      ],
      railKtx: [
        '아산역에서 전철을 탑니다.',
      ...
      // 버스는 동부역, 셔틀은 동부광장 건너편으로 승차 위치가 다르다. '1번 출구'까지만 공통으로 묶는다.
